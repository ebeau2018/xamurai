...
namespace Xamurai
{
    public class SampleViewModel : BindableBase
    {
        ...
        private void BuildCars()
        {
            Cars = new ObservableCollection<ObservableCollection<Car>>
            {
        ...
        private ObservableCollection<ObservableCollection<Car>> _cars;

        public ObservableCollection<ObservableCollection<Car>> Cars
        {
            get { return _cars; }
            set { SetProperty(ref _cars, value); }
        }
